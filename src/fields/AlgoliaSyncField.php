...
namespace brilliance\algoliasync\fields;

use brilliance\algoliasync\AlgoliaSync;
use brilliance\algoliasync\assetbundles\algoliasyncfieldfield\AlgoliaSyncFieldFieldAsset;
...
class AlgoliaSyncField extends Field
{
    ...
    public function getSettingsHtml(): string|null
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'algolia-sync/_components/fields/AlgoliaSyncField_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(AlgoliaSyncFieldFieldAsset::class);
        ...
        return Craft::$app->getView()->renderTemplate(
            'algolia-sync/_components/fields/AlgoliaSyncField_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
